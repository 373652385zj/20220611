 ...
 * @LastEditTime: 2022-06-30 16:30:11
...
export function updateValidCode(query) {
  return new Promise((resolve, reject) => {
    _this.$axios
      .post("/api/updateValidCode", query)
      .then((res) => {
        resolve(res);
      })
      .catch((err) => {
...
export function getIdentifyList(query) {
  return new Promise((resolve, reject) => {
    _this.$axios
      .post("/api/getIdentifyList", query)
      .then((res) => {
        resolve(res);
      })
      .catch((err) => {
